...
const file_lf_a2a_v1_a2a_proto_rawDesc = "" +
	...
	"task_id,id\x82\xd3\xe4\x93\x02qZ<*:/{tenant}/tasks/{task_id=*}/pushNotificationConfigs/{id=*}*1/tasks/{task_id=*}/pushNotificationConfigs/{id=*}BT\n" +
	"\x14com.google.lf.a2a.v1B\x03A2AP\x01Z)github.com/alis-exchange/a2a-go/lf/a2a/v1\xaa\x02\tLf.A2a.V1b\x06proto3"
